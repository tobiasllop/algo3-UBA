...
* El valor z<sup>*</sup> $\in \mathbb{R}$ es el valor óptimo del problema y cualquier solución factible x<sup>*</sup> $\in S$ tal que f(x<sup>*</sup>) = z<sup>*</sup> se llama un óptimo del problema.
